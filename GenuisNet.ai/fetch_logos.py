#!/usr/bin/env python3
"""
Script pour télécharger les logos manquants des outils AI
"""
...
# Liste des logos à télécharger avec leurs URLs officielles
LOGOS_TO_DOWNLOAD = {
    # Cybersecurity (prioritaires)
    'okta': 'https://logo.clearbit.com/okta.com',
    'qualys': 'https://logo.clearbit.com/qualys.com',
    'snyk': 'https://logo.clearbit.com/snyk.io',
    'rapid7': 'https://logo.clearbit.com/rapid7.com',
    'tenable': 'https://logo.clearbit.com/tenable.com',
    'wiz': 'https://logo.clearbit.com/wiz.io',
    'cyberark': 'https://logo.clearbit.com/cyberark.com',
    'lacework': 'https://logo.clearbit.com/lacework.com',
    'exabeam': 'https://logo.clearbit.com/exabeam.com',
    'cisco-securex': 'https://logo.clearbit.com/cisco.com',
    'sophos-interceptx': 'https://logo.clearbit.com/sophos.com',
    'trend-micro-vision-one': 'https://logo.clearbit.com/trendmicro.com',
    'mcafee-mvision': 'https://logo.clearbit.com/mcafee.com',
    'carbon-black': 'https://logo.clearbit.com/carbonblack.com',
    'symantec-endpoint': 'https://logo.clearbit.com/broadcom.com',
    ...
    'lumen5': 'https://logo.clearbit.com/lumen5.com',
    'kapwing': 'https://logo.clearbit.com/kapwing.com',
    'kling-ai': 'https://logo.clearbit.com/kuaishou.com',

    # Image
    'midjourney': 'https://logo.clearbit.com/midjourney.com',
    'clipdrop': 'https://logo.clearbit.com/clipdrop.co',

    # Networking
    'ansible': 'https://logo.clearbit.com/ansible.com',
    'terraform': 'https://logo.clearbit.com/terraform.io',
    'prtg': 'https://logo.clearbit.com/paessler.com',
    'zabbix': 'https://logo.clearbit.com/zabbix.com',
    'juniper-mist': 'https://logo.clearbit.com/juniper.net',
    ...
    'murf-ai': 'https://logo.clearbit.com/murf.ai',
...
def main():
    ...
    for name, url in LOGOS_TO_DOWNLOAD.items():
...
LOGOS_PHASE2 = {
    ...
    'windsurf': 'https://avatars.githubusercontent.com/u/19650571',
}
