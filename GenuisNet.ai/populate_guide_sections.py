#!/usr/bin/env python3
"""
Script to populate Beginner, Intermediate, and Advanced guide sections
"""
...
def main():
    ...
    intermediate_guides = [
        ("Advanced Prompt Engineering", "Master complex prompting techniques for sophisticated AI interactions", "35 min", "8 lessons",
         '<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>', "grad-inter-1", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("AI Workflow Automation", "Build automated workflows combining multiple AI tools", "40 min", "9 lessons",
         '<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="M12 22V12M22 8.5l-10 5.75M2 8.5l10 5.75"/>', "grad-inter-2", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("Custom AI Training Basics", "Learn to fine-tune AI models for specialized tasks", "45 min", "10 lessons",
         '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>', "grad-inter-3", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("AI API Integration", "Connect AI capabilities to your applications via APIs", "38 min", "9 lessons",
         '<path d="M16 18l2-2-2-2M8 6L6 8l2 2"/><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/>', "grad-inter-4", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("Multimodal AI Applications", "Combine text, image, and audio AI for powerful solutions", "42 min", "10 lessons",
         '<path d="M3 3v18h18M7 16l4-4 4 4 6-6"/>', "grad-inter-5", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("AI Content Strategy", "Develop professional content workflows using AI tools", "35 min", "8 lessons",
         '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8"/>', "grad-inter-6", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("AI Data Analysis", "Leverage AI for advanced data processing and insights", "40 min", "9 lessons",
         '<path d="M3 3v18h18"/><path d="M18 17V9M13 17V5M8 17v-3"/>', "grad-inter-7", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("Building AI Chatbots", "Create custom chatbots for business and personal use", "45 min", "10 lessons",
         '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M9 10h.01M15 10h.01M12 14h.01"/>', "grad-inter-8", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("AI Video & Animation", "Master AI tools for video creation and editing", "38 min", "9 lessons",
         '<path d="M23 7l-7 5 7 5V7z"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/>', "grad-inter-9", "#3B82F6", "#2563EB", "59, 130, 246"),

        ("AI Testing & Optimization", "Learn to test, benchmark, and improve AI outputs", "35 min", "8 lessons",
         '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="M22 4L12 14.01l-3-3"/>', "grad-inter-10", "#3B82F6", "#2563EB", "59, 130, 246"),
    ]

    # Advanced Guides (Violet theme)
    advanced_guides = [
        ("Enterprise AI Architecture", "Design scalable AI systems for large organizations", "50 min", "12 lessons",
         '<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>', "grad-adv-1", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("AI Model Development", "Build and deploy custom AI models from scratch", "60 min", "14 lessons",
         '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>', "grad-adv-2", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("Advanced Neural Networks", "Deep dive into transformer models and neural architecture", "55 min", "13 lessons",
         '<circle cx="12" cy="12" r="3"/><path d="M12 1v6M12 17v6M4.22 4.22l4.24 4.24M15.54 15.54l4.24 4.24M1 12h6M17 12h6M4.22 19.78l4.24-4.24M15.54 8.46l4.24-4.24"/>', "grad-adv-3", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("AI Security & Privacy", "Implement robust security measures for AI systems", "45 min", "11 lessons",
         '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 9v4M12 17h.01"/>', "grad-adv-4", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("Production AI Deployment", "Deploy and monitor AI models in production environments", "50 min", "12 lessons",
         '<path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5M2 12l10 5 10-5"/>', "grad-adv-5", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("AI Performance Tuning", "Optimize AI models for speed, cost, and accuracy", "48 min", "11 lessons",
         '<path d="M12 20v-6M6 20V10M18 20V4"/>', "grad-adv-6", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("Custom LLM Fine-tuning", "Train specialized language models for domain expertise", "58 min", "13 lessons",
         '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>', "grad-adv-7", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("AI Ethics Implementation", "Build ethical frameworks into AI systems and workflows", "42 min", "10 lessons",
         '<path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/>', "grad-adv-8", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("Multi-Agent AI Systems", "Orchestrate multiple AI agents for complex tasks", "52 min", "12 lessons",
         '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/>', "grad-adv-9", "#A855F7", "#7C3AED", "168, 85, 247"),

        ("AI Research & Innovation", "Explore cutting-edge AI research and experimental techniques", "55 min", "13 lessons",
         '<circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/>', "grad-adv-10", "#A855F7", "#7C3AED", "168, 85, 247"),
    ]
    ...
    # We need to find the empty <div class="guides-grid"> sections
    beginner_insert_line = None
    intermediate_insert_line = None
    advanced_insert_line = None

    for i, line in enumerate(lines):
        # Look for Beginner section grid
        if 'Beginner Guides' in lines[max(0, i-15):i] and '<div class="guides-grid">' in line:
            beginner_insert_line = i + 1
        # Look for Intermediate section grid
        elif 'Intermediate Guides' in lines[max(0, i-15):i] and '<div class="guides-grid">' in line:
            intermediate_insert_line = i + 1

    print(f"Found Beginner insert point at line: {beginner_insert_line}")
    print(f"Found Intermediate insert point at line: {intermediate_insert_line}")

    # Insert Beginner guides
    if beginner_insert_line:
        lines.insert(beginner_insert_line, beginner_html + '\n')
        print("✅ Inserted 10 Beginner guides")

    # Adjust intermediate line number after beginner insertion
    if intermediate_insert_line and beginner_insert_line and intermediate_insert_line > beginner_insert_line:
        intermediate_insert_line += 1

    # Insert Intermediate guides (after the existing one)
    if intermediate_insert_line:
        # Find the end of existing intermediate guide card
        for i in range(intermediate_insert_line, min(intermediate_insert_line + 100, len(lines))):
            if '</div>' in lines[i] and 'guide-card' in ''.join(lines[max(0, i-50):i]):
                lines.insert(i + 1, '\n' + intermediate_html + '\n')
                print("✅ Inserted 10 Intermediate guides")
                break

    # Now add Advanced section before "Ready to Start?"
    # Find the "Ready to Start?" section
    ready_section_line = None
    for i, line in enumerate(lines):
        if 'Ready to Start?' in line:
            ready_section_line = i
            break

    if ready_section_line:
        # Insert Advanced section header and guides before "Ready to Start?"
        advanced_section_header = '''            <!-- Section: Advanced Guides -->
            <div id="advanced"></div>
            <div class="section-divider">
                <div style="display: flex; align-items: center; gap: var(--space-md); justify-content: center;">
                    <svg viewBox="0 0 24 24" fill="none" stroke="url(#grad-advanced-section)" stroke-width="2" width="32" height="32" style="filter: drop-shadow(0 0 8px rgba(168, 85, 247, 0.6));">
...
'''
        # Find the line with the closing </div> before "Ready to Start?"
        for i in range(ready_section_line - 1, max(0, ready_section_line - 10), -1):
            if '</div>' in lines[i] and 'guides-grid' not in lines[i]:
                lines.insert(i + 1, '\n' + advanced_section_header)
                print("✅ Inserted Advanced section with 10 guides")
                break
    ...
    print(f"\n🎉 Successfully populated all guide sections!")
    print(f"   - 10 Beginner guides (Green)")
    print(f"   - 10 Intermediate guides (Blue)")
    print(f"   - 10 Advanced guides (Violet)")
    print(f"   Total: 30 new guide cards added")
