...
const articleTranslations = {
    en: {
        pageTitle: "Claude 3.5 Sonnet Update: What's New and Why It Matters | GenuisNet.ai",
    ...
    es: {
        pageTitle: "Actualización de Claude 3.5 Sonnet: Qué Hay de Nuevo y Por Qué Importa | GenuisNet.ai",
    ...
    fr: {
        pageTitle: "Mise à Jour de Claude 3.5 Sonnet : Quoi de Neuf et Pourquoi C'est Important | GenuisNet.ai",
    ...
    de: {
        pageTitle: "Claude 3.5 Sonnet Update: Was ist Neu und Warum es Wichtig ist | GenuisNet.ai",
    ...
    pt: {
        pageTitle: "Atualização Claude 3.5 Sonnet: O Que Há de Novo e Por Que Importa | GenuisNet.ai",
    ...
    zh: { pageTitle: "Claude 3.5 Sonnet更新：新功能及其重要性 | GenuisNet.ai", heroTitle: "Claude 3.5 Sonnet更新：新功能及其重要性", heroExcerpt: "Anthropic的最新模型在编码和分析方面带来了令人印象深刻的改进。", footerDesc: "您值得信赖的 AI 工具评论、比较和指南来源。", footerCategories: "类别", footerResources: "资源", footerCopyright: "© 2026 GenuisNet.ai. 保留所有权利。" },
    ja: { pageTitle: "Claude 3.5 Sonnetアップデート：新機能とその重要性 | GenuisNet.ai", heroTitle: "Claude 3.5 Sonnetアップデート：新機能とその重要性", heroExcerpt: "Anthropicの最新モデルは、コーディングと分析に印象的な改善をもたらします。", footerDesc: "AIツールのレビュー、比較、ガイドの信頼できる情報源。", footerCategories: "カテゴリー", footerResources: "リソース", footerCopyright: "© 2026 GenuisNet.ai. 全著作権所有。" },
    ko: { pageTitle: "Claude 3.5 Sonnet 업데이트: 새로운 기능과 중요성 | GenuisNet.ai", heroTitle: "Claude 3.5 Sonnet 업데이트: 새로운 기능과 중요성", heroExcerpt: "Anthropic의 최신 모델은 코딩 및 분석에 인상적인 개선을 가져옵니다.", footerDesc: "AI 도구 리뷰, 비교 및 가이드의 신뢰할 수 있는 출처.", footerCategories: "카테고리", footerResources: "리소스", footerCopyright: "© 2026 GenuisNet.ai. 모든 권리 보유." },
    ar: { pageTitle: "تحديث Claude 3.5 Sonnet: ما الجديد ولماذا هو مهم | GenuisNet.ai", heroTitle: "تحديث Claude 3.5 Sonnet: ما الجديد ولماذا هو مهم", heroExcerpt: "أحدث نموذج من Anthropic يجلب تحسينات مذهلة للبرمجة والتحليل.", footerDesc: "مصدرك الموثوق لمراجعات ومقارنات وأدلة أدوات الذكاء الاصطناعي.", footerCategories: "الفئات", footerResources: "الموارد", footerCopyright: "© 2026 GenuisNet.ai. جميع الحقوق محفوظة." },
    hi: { pageTitle: "Claude 3.5 Sonnet अपडेट: क्या नया है और यह क्यों महत्वपूर्ण है | GenuisNet.ai", heroTitle: "Claude 3.5 Sonnet अपडेट: क्या नया है और यह क्यों महत्वपूर्ण है", heroExcerpt: "Anthropic का नवीनतम मॉडल कोडिंग और विश्लेषण में प्रभावशाली सुधार लाता है।", footerDesc: "AI टूल समीक्षाओं, तुलनाओं और गाइड के लिए आपका विश्वसनीय स्रोत।", footerCategories: "श्रेणियाँ", footerResources: "संसाधन", footerCopyright: "© 2026 GenuisNet.ai. सर्वाधिकार सुरक्षित।" }
};
