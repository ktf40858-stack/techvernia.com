...
def update_logo_in_review(file_path):
    ...
    # Pattern to match the old inline SVG logo
    old_logo_pattern = r'<a href="\.\.\.\/\.\.\.\/index\.html" class="logo">\s*<span class="logo-icon">\s*<svg.*?<\/svg>\s*<\/span>\s*<span class="logo-text">Genuis<span class="highlight">Net<\/span>\.ai<\/span>\s*<\/a>'
    ...
    old_footer_logo_pattern = r'<a href="\.\.\.\/\.\.\.\/index\.html" class="footer-logo">\s*<span class="logo-icon">\s*<svg.*?<\/svg>\s*<\/span>\s*<span class="logo-text">Genuis<span class="highlight">Net<\/span>\.ai<\/span>\s*<\/a>'
...
for category in review_categories:
    ...
    for file_path in sorted(review_files):
        ...
        if update_logo_in_review(file_path):
            ...
            print(f"  Skipped: {category}/{filename} (no change needed)")
