#!/usr/bin/env python3
"""Add i18n script tags to Architecture HTML files."""
import re
...
HTML_DIR = Path("GenuisNet.ai/pages/reviews/architecture")
...
def main():
    print("="*60)
    print("ADDING I18N SCRIPTS TO ARCHITECTURE HTML FILES")
    print("="*60)
