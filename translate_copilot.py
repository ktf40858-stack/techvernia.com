#!/usr/bin/env python3
"""
Traduction des clés Copilot avec Argos Translate
"""
import json
...
print("📝 57 clés Copilot à traduire")
print("🌍 9 langues cibles")
print("📊 Total: 513 traductions\n")

# Charger le contenu à traduire
with open('copilot_content_to_translate.json', 'r', encoding='utf-8') as f:
    content = json.load(f)
...
# Sauvegarder
output_file = 'copilot_translations_all_langs.json'
with open(output_file, 'w', encoding='utf-8') as f:
    json.dump(all_results, f, indent=2, ensure_ascii=False)

print("\n" + "="*60)
print("✅ TRADUCTION COPILOT TERMINÉE!")
