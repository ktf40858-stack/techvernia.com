"""
Final script to merge translations and generate i18n files for Networking tools
Run this AFTER all 33 translation agents have completed
"""
import json
import os
...
def merge_translations_for_tool(tool_name):
    ...
    for batch_num in range(1, 4):
        batch_file = f"GenuisNet.ai/pages/reviews/networking/{tool_name}-batch{batch_num}.json"
    ...
    # Merge FAQ translations from 3 batches (if they exist)
    for batch_num in range(1, 4):
        faq_batch_file = f"GenuisNet.ai/pages/reviews/networking/{tool_name}-faqs-batch{batch_num}.json"
    ...
    en_content_file = f"GenuisNet.ai/pages/reviews/networking/{tool_name}-en.json"
    en_faq_file = f"GenuisNet.ai/pages/reviews/networking/{tool_name}-faqs-en.json"
...
# Process all tools
print("\n" + "="*60)
print("FINALIZING NETWORKING I18N FILES")
print("="*60)
...
print("="*60)
print("\nNetworking category is now fully multilingual!")
print("All 8 tools ready with 9 language translations.")
