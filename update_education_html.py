...
base_dir = r"C:\Users\Freddy\Desktop\GeniusNet.ai\GenuisNet.ai\pages\reviews\education"
...
<li class="nav-item"><a class="nav-link active" href="../../categories/ai-education.html"><span data-i18n="nav.categories">Categories</span></a></li>
...
def update_html(tool):
    filepath = os.path.join(base_dir, f"{tool}.html")
    ...
    # 1. Remplacer la navbar (de <nav à </nav>)
    content = re.sub(
    ...
    # 2. Ajouter les scripts avant </body> si pas déjà présents
...
<script src="../../../js/complete-translate.js"></script>
    ...
    print(f"[OK] Updated {tool}.html")

print("Updating Education HTML files...")
for tool in tools:
    update_html(tool)
