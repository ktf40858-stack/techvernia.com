#!/usr/bin/env python3
"""
Extraction des clés de traduction de copilot.html
"""
from bs4 import BeautifulSoup
import json
import re

print("🔍 Extraction des clés de Copilot...")

# Lire le fichier HTML
with open('GenuisNet.ai/pages/reviews/chatbots/copilot.html', 'r', encoding='utf-8') as f:
    html_content = f.read()
...
with open('copilot_content_to_translate.json', 'w', encoding='utf-8') as f:
    json.dump(translations, f, indent=2, ensure_ascii=False)

print(f"💾 Sauvegardé dans copilot_content_to_translate.json")
